      ...
      <Container sx={styles.container}>
        <Grid sx={styles.grid}>
          <Box sx={styles.content}>
            <Heading as="h3">
              Your digital projects done better and faster
            </Heading>
            <Text as="p">
              Web applications consulting & development with short time to market
            </Text>
            {/* <Text as="p">
              We deliver fast and efficient apps for your needs with short time to market.
            </Text>
            <Text as="p">
              We give you expertise and value on web development, cloud architecture, devops.
            </Text> */}
