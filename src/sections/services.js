...
const SERVICES_DATA = [
  {
    ...
    text: "Technical and project management consulting for making dev improving your project value in time",
  },
  {
    icon: icon2,
    title: "Web Development & DevOps",
    text: "Frontend & backend applications development from code to deploy",
  },
  {
    icon: icon3,
    title: "Cloud Architecture & Data",
    text: "Design the best technical architecture for your business needs",
  },
  {
    icon: icon4,
    title: "Cybersecurity guidelines and remediations",
    text: "Cloud cybersecurity, Audits and Pentests, Digital trust",
  },
];
    ...
    <Box sx={styles.services} id="services">
      <Container>
        <BlockTitle
          ...
          title="Technical versatility for a wide range of interventions"
