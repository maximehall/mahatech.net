          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as="h3">The Web Technical Expertise you need</Heading>
                <Text as="p">
                  Web Development, DevOps & Cloud Architecture 
                </Text>
              </Box>
              <Box as="ul" sx={styles.list}>
                <Text as="li">
                  <IoIosCheckmarkCircle />
                  Frontend & Backend web developments
                </Text>
                <Text as="li">
                  <IoIosCheckmarkCircle />
